...
export default class Help extends Vue {
  videos = [
    {
      readMore: false,
      name: 'Vurteau Broadcast Studio Quickstart',
      description: 'How to Download, Install, and Go Live with Vurteau Broadcast Studio.',
      link: 'https://www.youtube.com/watch?v=d--1z_W9IVw&t=1s',
      image: './media/images/yt-thumbnails/slobs-quickstart.png',
      infoOverview: 'If you have made it here, you have already successfully downloaded and installed Vurteau Broadcast Studio. Let’s get into a few of the reasons why many streamers have Vurteau Broadcast Studio as their go-to choice for streaming software.',
      infoDirections: 'Vurteau Broadcast Studio takes 4 windows that are essential for every streamer (chat, live stream preview, recent events, and OBS Scene Switcher) and condenses them into 1 tab in Vurteau Broadcast Studio. This preserves valuable screen real estate, reduces cpu load, and you can lower cpu load to leverage a higher quality stream. The Vurteau theme library is the largest library of themes and widgets in the world. The theme library provides $1M worth of content available for free, with one-click installation. With Vurteau Broadcast Studio, you can set up to go live in mere minutes with our Optimization feature, quickly import scenes & settings from OBS, and have easy one-click installation of themes and widgets.'
    },
    {
      readMore: false,
      name: 'Merch Store Setup',
      description: 'Build a Vurteau automated Merch Store in under 60 seconds.',
      link: 'https://www.youtube.com/watch?v=epd8cYG2ArI',
      image: './media/images/yt-thumbnails/merch-setup.png',
      infoOverview: 'Having a merch store is a great way for your viewers to support you and promote your channel by showing off a hoodie, some mugs, or other merch with your brand printed on it. The Vurteau merch store is conveniently set up in a way that your viewers can browse your store, make their purchase, and have the items produced and shipped with a quick turnaround time and no additional work for you!',
    ...
    },
    {
      ...
      description: 'Earn revenue and raise money for charity by sharing Vurteau Broadcast Studio with your friends.',
      link: 'https://www.youtube.com/watch?v=cHMyxE5NsFQ',
      image: './media/images/yt-thumbnails/affiliates-guide.png',
      infoOverview: 'If you’ve been livestreaming to an audience, chances are at some point one of your viewers has asked what software you use to broadcast. We’ve created the Vurteau Affiliate program to reward our loyal user base for pointing their friends to our software with a recommendation. Here’s how to set it up.',
      infoDirections: 'The cash you’ll receive for referrals is processed through PayPal, so the first thing you’ll want to do is make sure that is set up and linked to your Vurteau account. Navigate to “Donation Settings” in the Dashboard located under “My Account”. If it shows you are connected, great, you can skip this step. If not, press the button and fill out the email for your PayPal and press “Connect”. After you’ve connected Paypal, navigate to the “Affiliates” tab under “Vurteau Broadcast Studio”. Here you’ll see confirmation that you’ve completed step 1, and here in step 2 you’ll be able to copy a unique URL created just for you. This link will allow your viewers and friends to download SLOBS and let us know how successful you were in referring us. You can share this link anywhere you think would be easy for viewers to find, whether it’s a channel info panel, in a Youtube video description, or DM to a friend. Once someone has installed SLOBS using your link, you will get an email from Vurteau. Just click the link and you’ll be prompted to update your password for your newly created Everflow.io login. After this step, you’ll be directed to your Affiliate Dashboard, which can also be accessed from your Vurteau Dashboard in the Affiliates section.'
    },
    {
      readMore: false,
    ...
    },
    {
      ...
      infoOverview: 'Sometimes alert issues come up. We have some tips on how to effectively identify and correct issues you may have with your alerts using Vurteau Broadcast Studio.',
      infoDirections: 'First we recommend trying the basics: making sure your software is up to date. Check your version of Vurteau Broadcast Studio to make sure it’s the current version. You can see what version your software is in the upper left side of the application. If you’re not sure, you can always get a fresh download to install from streamlabs.com, where we always have the latest version to download. Most Vurteau tools use Twitch, YouTube or other APIs to pull info. Logging out of Vurteau and then logging back in, with the streaming service account that was causing issues, will attempt to recreate the connection. In Vurteau Broadcast Studio, make sure you fully log out of the application by clicking the logout button on the upper-right. Restart the application and log back in to reactivate your widgets. Sometimes an Alert issue may originate from the connection between your Vurteau Broadcast Studio and the website, or the cache within the source. If you are using Vurteau Broadcast Studio, try to clear the cache by removing your Widget Sources and re-adding them back in. Please watch our YouTube video for more suggestions.'
    },
    {
      readMore: false,
